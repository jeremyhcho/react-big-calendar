  ...
  MonthView.prototype.renderOverlay = function renderOverlay() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_Popup2.default, _extends({}, this.props, {
        ...
        showMoreRef: overlay.showMoreRef
      }))
    );
  };
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleShowMore = function (events, date, cell, slot, ref) {
    ...
    if (popup) {
      ...
      _this5.setState({
        overlay: { date: date, events: events, position: position, showMoreRef: ref }
      });
    } else {
      (0, _helpers.notify)(onDrillDown, [date, getDrilldownView(date) || _constants.views.DAY]);
    }

    (0, _helpers.notify)(onShowMore, [events, date, slot, ref]);
  };
};
